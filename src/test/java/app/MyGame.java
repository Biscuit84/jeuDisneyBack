...
public class MyGame {
	...
	public static void jouer() 
	{
		...
		try {
			...
			//la liste des perso de chaque joueur apr�s le choix
			...
			int positionCase = 0; //mettre case d�part
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			//Ajouter le perso et sa position � la liste des parties du joueur
	...
	//		menuJoueur();
	//		
	//		Case d�part List<Plateau> id 0
	//		Pouvoir?
	//		Lancer d� random()
	//		d�placement de x sur la List<Plateau>
	...
	//			Case = id nom 
	//			Plateau= id plateau 
	//			Case_plateau id p id Case ordre nb d�placement
	//			
